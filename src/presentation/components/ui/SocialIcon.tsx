// ============================================
// 14. src/presentation/components/ui/SocialIcon.tsx
// ============================================
...
export const SocialIcon: React.FC<SocialIconProps> = ({
  ...
  <button
    type="button"
    onClick={onClick}
    className={`rounded-full text-white font-bold transition-all hover:scale-110 transform shadow-lg hover:shadow-xl flex items-center justify-center ${color} ${className}`}
    title={`${provider}`}
