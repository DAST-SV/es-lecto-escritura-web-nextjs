...
// ✅ CON DISEÑO MEJORADO Y VALIDACIÓN SLUG
// ============================================
...
import { BaseModal } from '@/src/presentation/components/shared/Modals';
import { 
  OrganizationType, 
...
export function CreateOrganizationModal({ 
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={handleClose} title="Nueva Organización" maxWidth="md">
      {error && (
