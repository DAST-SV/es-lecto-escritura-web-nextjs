...
/**
 * Obtiene un libro con toda su metadata (categorías, géneros, etiquetas, valores)
...
export async function getBookWithMetadata(idLibro: string): Promise<LibroConMetadata | null> {
  ...
  try {
    ...
    // 2. Obtener categorías del libro (en paralelo)
    ...
    // 6. Construir y retornar objeto completo
