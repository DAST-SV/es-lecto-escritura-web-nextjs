...
CREATE TABLE IF NOT EXISTS books.books (
  ...
  level_id UUID REFERENCES books.levels(id) ON DELETE SET NULL,
  cover_url TEXT,
...
CREATE INDEX IF NOT EXISTS idx_books_level ON books.books(level_id) WHERE deleted_at IS NULL;
