...
-- VERSIÓN: 3.0 - Consolidado con sistema de autenticación completo
...
-- Tipo de usuario/rol (alineados con frontend)
DO $$ BEGIN
...
COMMENT ON TABLE app.organizations IS 'Catálogo de organizaciones: escuelas, familias, grupos de lectura, etc.';
...
COMMENT ON TABLE app.user_relationships IS 'Relaciones entre usuarios (padre-hijo, maestro-estudiante, etc.)';
...
-- Función: Verificar si es admin de organización
...
-- Vista: Tipos de usuario activos (legacy)
